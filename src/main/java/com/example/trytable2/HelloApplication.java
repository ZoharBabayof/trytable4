...
//        specCol.setPrefWidth(100);
        ...
        AnchorPane.setTopAnchor(tabPane2, 15.0);
        AnchorPane.setRightAnchor(tabPane2, 15.0);
        AnchorPane.setBottomAnchor(tabPane2, 15.0);
        AnchorPane.setLeftAnchor(tabPane2, 15.0);
        pane2.getChildren().addAll(tabPane2,label2,table2);
